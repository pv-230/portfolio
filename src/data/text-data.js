const projects = [
  ...
  },
  {
    name: 'Battleship',
    description:
      "A recreation of Milton Bradley's classic board game. Play against a computer and try to" +
      'sink all their ships. Primarily an exercise in using jest for unit tests, however the ' +
      'logic for the opponent became somewhat of a focus.',
    tech: ['Jest', 'Webpack'],
  ...
  },
  {
    ...
    description:
      'Try to click on each card only once. The deck shuffles after each click. This ' +
      'project was created to practing using React components with hooks.',
    tech: ['React', 'Webpack'],
